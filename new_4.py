...
def main(cmd_data):
    ...
    return write_data(arg, content, title)
...
def write_data(args, content, title):
...
'''
if __name__ == "__main__":
    print(main(os.system('python new_4.py --files students1.csv students2.csv --report file_report')))
'''
...
if __name__ == "__main__":
    print(
        main(
            subprocess.run(
                [
                    'python', 'new_4.py', '--files',
                    'tests/students1.csv', 'tests/students1.csv',
                    '--report', 'file_report'
                ],
                capture_output=True
            ).stdout
